...
<main>
		<div class="main_regT container">
			...
			<div class="form card text-white mb-3 tarea morado mx-auto container p-3">
				<form class="text-white" method="POST" action="{{ route('adminrestaurantes.update', $restaurante->id) }}" enctype="multipart/form-data">
		|		@csrf
				@method('PATCH')
					<div class="form-group">
						<label for="title">Post</label>
						<input value="{{ $restaurante->title}}" type="text" class="form-control" name="title">
					</div>
					<div class="form-group">
						<label for="title">Creado por: </label>
						<input value="{{ $restaurante->author}}" type="text" class="form-control" name="author">
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<a href="{{ asset("restaurantes/$restaurante->file" )}}">{{$restaurante->file}}</a>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<input type="date" name="date" value="{{$restaurante->date}}"
